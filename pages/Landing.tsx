...
export const Landing: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row w-full mt-24 lg:mt-0 min-h-[calc(100svh-6rem)] lg:h-screen overflow-visible lg:overflow-hidden">
      ...
      {/* Lifestyle Section */}
      <div className="w-full lg:w-1/3 h-[calc((100svh-6rem)/3)] min-h-[230px] lg:min-h-0 lg:h-full relative border-b lg:border-b-0 lg:border-r border-white/20">
        <Slideshow 
      ...
      {/* ArhanSiam Section */}
      <div className="w-full lg:w-1/3 h-[calc((100svh-6rem)/3)] min-h-[230px] lg:min-h-0 lg:h-full relative">
        <Slideshow 
