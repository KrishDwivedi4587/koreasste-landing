        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-32 items-stretch">
            ...
            <div className="group flex flex-col items-center p-8 bg-white shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-1 transition-all duration-300 rounded-lg border border-gray-100">
                <div className="w-16 h-16 rounded-full bg-gray-50 flex items-center justify-center mb-6 group-hover:bg-koreasste-gold/10 transition-colors duration-500 shrink-0">
                    <Mail className="w-6 h-6 text-gray-700 group-hover:text-koreasste-gold transition-colors duration-500" />
                </div>
            ...
            <a href="https://wa.me/919313232404" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center p-8 bg-white shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-1 transition-all duration-300 rounded-lg border border-gray-100 cursor-pointer">
                <div className="w-16 h-16 rounded-full bg-gray-50 flex items-center justify-center mb-6 group-hover:bg-koreasste-gold/10 transition-colors duration-500 shrink-0">
                    <MessageCircle className="w-6 h-6 text-gray-700 group-hover:text-koreasste-gold transition-colors duration-500" />
                </div>
                <h3 className="font-serif text-xl lg:text-2xl mb-6 text-gray-900 shrink-0">Lifestyle WhatsApp</h3>
                <div className="flex flex-col items-center justify-center flex-grow">
                    <span className="text-gray-500 group-hover:text-koreasste-gold transition-colors duration-300 font-sans text-sm md:text-base">
                        Chat on WhatsApp
                    </span>
            ...
            <a href="https://wa.me/916352432404" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center p-8 bg-white shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-1 transition-all duration-300 rounded-lg border border-gray-100 cursor-pointer">
                <div className="w-16 h-16 rounded-full bg-gray-50 flex items-center justify-center mb-6 group-hover:bg-koreasste-gold/10 transition-colors duration-500 shrink-0">
                    <MessageCircle className="w-6 h-6 text-gray-700 group-hover:text-koreasste-gold transition-colors duration-500" />
                </div>
