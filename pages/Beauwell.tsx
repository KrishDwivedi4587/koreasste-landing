...
const nutrition: Product[] = [
  ...
  { id: 'n4', name: 'Prysm iO', category: 'Nutrition', image: '/beauwell/PrysmIO.jpg', description: 'Cutting-edge tool that non-invasively measures skin carotenoid levels.' },
];
  ...
  return (
    <div className="bg-white min-h-screen pt-20 overflow-x-hidden">
      ...
      <ProductGrid 
        ...
        description="Scientifically formulated supplements by PharmaNex for optimal health."
        products={nutrition}
        theme="beauwell"
      />
